...
import static com.finderlo.weixzz.database.Table.TokenTable.*;
...
public class TokenDao {
    ...
    public TokenModel getCurrentTokenModel() {
        Cursor cursor = mDatabase.query(TokenTable.TABLE_NAME_Token, null,
                TokenTable.KEY_ISCURRENT + "=?", new String[]{"true"}, null, null, null);
    ...
    public boolean isTokenAlreadyExistByName(String name) {
        ...
        Cursor cursor = mDatabase.query(TokenTable.TABLE_NAME_Token, null,
                TokenTable.KEY_USER_NAME + "=?", new String[]{name}, null, null, null);
    ...
    public List<TokenModel> getAll() {
        Cursor cursor = mDatabase.query(TokenTable.TABLE_NAME_Token, null, null, null, null, null, null);
    ...
    private List<TokenModel> parseCursorToTokenModel(Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            do {
                TokenModel tokenModel = new TokenModel();
                tokenModel.setUid(cursor.getString(cursor.getColumnIndex(TokenTable.KEY_UID)));
                tokenModel.setCurrent(Boolean.valueOf(cursor.getString(cursor.getColumnIndex(TokenTable.KEY_ISCURRENT))));
                tokenModel.setExpireDate(cursor.getLong(cursor.getColumnIndex(TokenTable.KEY_EXPIRE_DATE)));
                tokenModel.setUserName(cursor.getString(cursor.getColumnIndex(TokenTable.KEY_USER_NAME)));
                tokenModel.setToken(cursor.getString(cursor.getColumnIndex(TokenTable.KEY_ACCESS_TOKEN)));
