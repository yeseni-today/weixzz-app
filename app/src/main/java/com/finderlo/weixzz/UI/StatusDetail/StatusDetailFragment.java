...
////            mStatusModel = StatusDao.getInstance().queryStatus(StatusDao.TYPE_IDSTR,status_idstr);
//        }else mStatusModel = StatusModel.parse(Constants.TEST_STATUS_JSON_STRING_1);
////        Log.d(TAG, "onCreate: "+ mStatusModel.text);
//
//    }
//
//
